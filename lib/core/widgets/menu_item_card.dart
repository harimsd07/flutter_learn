        ...
        child: Container(
          decoration: BoxDecoration(
            ...
            border: Border(
              ...
              top: BorderSide(color: isDark ? AppColors.darkBorder : const Color(0x0A000000)),
              right: BorderSide(color: isDark ? AppColors.darkBorder : const Color(0x0A000000)),
              bottom: BorderSide(color: isDark ? AppColors.darkBorder : const Color(0x0A000000)),
            ),
          ),
